...
atoms = read_pdb_atoms(pose_path)

# DPP-IV catalytic residues (chain A)
Ser630_OG = atoms[("A", 630, "SER", "OG")]
Tyr547_OH = atoms[("A", 547, "TYR", "OH")]
Glu205_OE1 = atoms[("A", 205, "GLU", "OE1")]
Glu205_OE2 = atoms[("A", 205, "GLU", "OE2")]
Glu206_OE1 = atoms[("A", 206, "GLU", "OE1")]
Glu206_OE2 = atoms[("A", 206, "GLU", "OE2")]

# GHRH N-terminus (chain B)
Tyr1_N = atoms[("B", 1, "TYR", "N")]
Ala2_N = atoms[("B", 2, "ALA", "N")]
Ala2_CA = atoms[("B", 2, "ALA", "CA")]
Ala2_C = atoms[("B", 2, "ALA", "C")]
Ala2_O = atoms[("B", 2, "ALA", "O")]
...
print(f"  {'Ser630 OG → Ala2 C (Å)':<35} {'2.53':>8} {d_ser630_ala2c:>8.2f} {status(d_ser630_ala2c, 2.0, 4.0, 'FAR'):>10}")
print(f"  {'Attack angle (°)':<35} {'113.6':>8} {attack_angle:>8.1f} {status(attack_angle, 80, 120, 'BAD'):>10}")
print(f"  {'Tyr1 N → Glu Oε (Å)':<35} {'1.87':>8} {d_tyr1_glu:>8.2f} {status(d_tyr1_glu, 0, 3.5, 'WEAK'):>10}")
print(f"  {'Ala2 O → Tyr547 OH (Å)':<35} {'3.15':>8} {d_ala2o_tyr547:>8.2f} {status(d_ala2o_tyr547, 2.5, 4.0, 'LOST'):>10}")
...
if passed >= 3:
    ...
    print(f"  ⚠️  Pose may need refinement")
print(f"{'='*60}\n")
